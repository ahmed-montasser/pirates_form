...
from .views import (FormView, UniversityFacultyView, UniversityFacultyALLView, ApplicantListView, TimeSlot_ListView,
                    TimeSlot_CreateView, TimeSlot_DeleteView, TimeSlot_EditView, ApplicantAdmin_EditView,
                    Faculty_EditView,
                    Faculty_CreateView, University_CreateView, University_EditView, ApplicantInterviewedListView,
                    ApplicantNonInterviewedListView, RedirectView, AdminView, ThankYou_View, UniversityListView)
...
urlpatterns = [
    ...
    # For Admins
    path('faculty_university/<int:u_id>/', UniversityFacultyView.as_view(), name='Univ Fac'),
    path('faculty_university_all/', UniversityFacultyALLView.as_view(), name='Univ Fac All'),
    ...
    path('applicants_interviewed_list/', ApplicantInterviewedListView.as_view(), name='Applicant Interviewed List'),
    path('applicants_non_interviewed_list/', ApplicantNonInterviewedListView.as_view(),
    ...
    path('univ_edit/<int:pk>/', University_EditView.as_view(), name='University Update'),
