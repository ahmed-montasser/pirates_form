...
class FormView(View):
    ...
    def post(self, request):
        ...
        applicant = FormApplierModel.objects.filter(email=applicant_email,
        ...
        if applicant.exists():
            ...
            f = FormApplierModel(first_name=applicant_first_name,
                ...
                if faculty_.faculty.lower() == 'engineering':
                    if applicant_department:
                        if applicant_department == 'other':
                            ...
                            applicant_department_other = request.POST.get('department_other', False)
...
class TimeSlot_ListView(View):
    def get(self, request):
        ...
        return render(request=request, template_name='form/timeslot_list.html', context=ctx)
...
class ApplicantAdmin_EditView(View):
    def get(self, request, pk):
        ...
        ctx = {'form': form}
        return render(request=request, context=ctx, template_name='form/applicants_admin.html')
